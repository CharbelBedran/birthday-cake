...
const TYPED_LINES = [
  "> Candice ",
  "...",
  "> Aujourd'hui, c'est ton anniversaire princesse <3 ",
  "...",
  "> Et donc je t'ai fais ce petit code pour te le souhaiter de manière original ",
  "٩(◕‿◕)۶ ٩(◕‿◕)۶ ٩(◕‿◕)۶"
];
...
export default function App() {
  ...
  useEffect(() => {
    isCandleLitRef.current = isCandleLit;
  }, [isCandleLit]);
  ...
  useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      if (hasAnimationCompletedRef.current && isCandleLitRef.current) {
  ...
  }, [hasStarted, playBackgroundMusic, closeImageModal]);
  ...
  return (
    <div className="App">
      ...
      {hasAnimationCompleted && isCandleLit && (
        <div className="hint-overlay">Appuie sur espace pour souffler la bougie</div>
      )}
      {selectedImageUrl && (
        <div
